...
package java.snikhil.jmeter.elasticsearch;
...
public  class JmeterElasticSearchBackendListenerClient extends
    ...
    private Map<String, Object> getMap(SampleResult result, BackendListenerContext context) {
        ...
        map.put("ConnectTime", result.getIdleTime());
    ...
    public Arguments getDefaultParameters() {
        ...
        arguments.addArgument("indexName", "socojmeter");
        arguments.addArgument("sampleType", "socojmeter");
